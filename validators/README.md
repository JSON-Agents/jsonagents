...
python3 -m jsonagents.cli validate ../../standard/examples/*.json
```
...
Full-featured validator with TypeScript support:
- ✅ JSON Schema validation with Ajv 8.x
- ✅ URI validation (`ajson://` scheme per RFC 3986)
...
npm install
npm test
npx jsonagents validate ../../examples/*.json
```

**Documentation:**
- [README.md](typescript/README.md) - Complete API documentation
- Tests: 29/29 passing with 85% coverage
