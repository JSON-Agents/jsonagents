...
import { Shield, Github, Home } from 'lucide-react';
...
export default function CodeOfConductPage() {
  ...
  useEffect(() => {
    fetch('/Standard/CODE_OF_CONDUCT.md')
      .then(res => res.text())
      .then(text => {
        setMarkdown(text);
        setLoading(false);
      ...
      .catch(err => {
        console.error('Failed to load CODE_OF_CONDUCT.md:', err);
        setLoading(false);
      });
  }, []);
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-200 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Shield className="mx-auto h-16 w-16 text-slate-800 mb-4" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-600">Loading code of conduct...</p>
          </div>
        ) : (
